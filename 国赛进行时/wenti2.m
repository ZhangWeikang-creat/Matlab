...
pao2=pao;
%遗传算法求解以及绘图
[bestpop,bestv]=gafun(pao1,pao2,zhu,zhuf,wei,fangzhi);
xzhu=plotfun2(bestpop,zhu,zhuf,pao1);
save('data\第二问结果2','bestv','bestpop')
writematrix([xd,yd,zd],'data\附件4.xlsx','Sheet',1,'Range','A2:C2')
writematrix(xzhu,'data\附件4.xlsx','Sheet',2,'Range','B2:D693')
writematrix(bestpop','data\附件4.xlsx','Sheet',3,'Range','B2:B693')
writecell(bianhao,'data\附件4.xlsx','Sheet',2,'Range','A2:A693')
writecell(bianhao,'data\附件4.xlsx','Sheet',3,'Range','A2:A693')